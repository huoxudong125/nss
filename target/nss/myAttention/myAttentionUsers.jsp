	...
	$(function() {
		...
		$(".cancelAttention").bind("click", function() {
			...
			art.dialog.confirm('你确定要取消关注吗？', function() {
				$.post("/nss/nssUser/cancelAttentionUser.action", {
					targetId : targetId
				}, processQuitResult);
			}, function() {
	...
	function goPage(pageNum) {
		if (pageNum != "") {
			if (isInteger(pageNum, "请使用整型")) {
				$("#usListPage").attr("action",
						"quaryAttentionUsers.action?pageIndex=" + pageNum);
				$("#usListPage").submit();
			}
		}
	}
...
<body>
	<s:form action="#" name="usListPage" id="usListPage" method="post"
		theme="simple">
		<!--顶部导航-->
		<div class="global_header">
			<div class="header clearfix">
				...
				<ul class="list">
					...
					<li class="current_page"><a href="/nss/userGroup/queryUserAttentionGroups.action" class="link">我的关注</a>
					</li>
				</ul>
				<div class="search">
		...
		<div class="main">
			...
			<div class="mainright">
				<div class="mygrouptitle">
					<span>我关注的用户 (${recordCount})</span>
				</div>
				<div class="mygrouplist">
					<s:iterator value="myAttentionUsers">
						<dl>
							<dt>
							...
							<dd>
								<p>
									<a href="#"><s:property value="user.userName" /></a> <input
										type="button" value="取消关注"
										targetId="<s:property value='user.id' />"
